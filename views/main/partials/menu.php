...
<a type="button" class="btn btn-info text-decoration-none" href="<?= BASE_URL ?>./views/tipo_documento/index.php">Tipos De Documento</a> 
<a type="button" class="btn btn-info text-decoration-none" href="<?= BASE_URL ?>./views/tipo_servicio/index.php">Tipo De Servicios</a> 
<a type="button" class="btn btn-info text-decoration-none" href="<?= BASE_URL ?>./views/ciudad/index.php">Departamentos</a>   
