 ...
 <ul class="navbar-nav bg-dark sidebar sidebar-dark accordion" id="accordionSidebar">
     ...
     <li class="nav-item">
         <a class="nav-link" href="<?= BASE_URL ?>./views/servicios/index.php">
             <i class="fas fa-fw fa-chart-area"><svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" fill="currentColor" class="bi bi-clipboard-plus-fill" viewBox="0 0 16 16">
     ...
     <li class="nav-item">
         <a class="nav-link" href="<?= BASE_URL ?>./views/clientes/index.php">
             <i class="fas fa-fw fa-chart-area"><svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" fill="currentColor" class="bi bi-people-fill" viewBox="0 0 16 16">
     ...
     <li class="nav-item">
         <a class="nav-link" href="<?= BASE_URL ?>./views/dispositivos/index.php">
             <i class="fas fa-fw fa-chart-area"><svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" fill="currentColor" class="bi bi-motherboard" viewBox="0 0 16 16">
     ...
     <li class="nav-item">
         <a class="nav-link" href="<?= BASE_URL ?>./views/reportes/index.php">
             <i class="fas fa-fw fa-table"><svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" fill="currentColor" class="bi bi-table" viewBox="0 0 16 16">
