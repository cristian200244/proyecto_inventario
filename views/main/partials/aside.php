...
<hr class="sidebar-divider my-0">
     ...
     <li class="nav-item">
         <a class="nav-link" href="<?= BASE_URL ?>./views/add/index.php">
             <i class="fas fa-fw fa-tachometer-alt "><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-gear-wide-connected" viewBox="0 0 16 16">
