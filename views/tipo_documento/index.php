                ...
                <div class="col">
                    <div class="collapse" id="collapseExample">
                        <div class="card card-body">
                            <div class="mb-3">
                                <form action="../../controller/documentoController.php" method="POST" onsubmit="submitFormTipo(event)" id="mi_form">
                                    <input type="hidden" name="c" value="1">
                                    <div class="input-group ">
                                        <input type="text" class="form-control" id="tipo" name="tipo" placeholder="Ingrese un nuevo tipo de documento" oninput="restrictInput(event)" maxlength="30">
