                    ...
                    <tbody>
                        ...
                        ?>
                                <tr>
                                    ...
                                    <td>
                                        <a class="btn btn-sm btn-outline-warning" href="../../controller/TipoDispositivosController.php?c=3&id=<?= $dispositivos->getId() ?>">Actualizar</a>
                                        <a class="btn btn-sm btn-outline-danger" href="../../controller/TipoDispositivosController.php?c=4&id=<?= $dispositivos->getId() ?>">Eliminar</a>
                                    </td>
