...
<div class="container-fluid">
    ...
    <div class="container text-center">
        ...
        <hr>
        <h1 class="h3 mb-4 text-gray-800 text-left">Marcas
            <a type="button" class="btn btn-sm btn-outline-primary btn-border-none" data-bs-toggle="collapse" href="#collapseExample" role="button" aria-expanded="false" aria-controls="collapseExample">
                    ...
                    <div class="mb-3">
                        <form action="../../controller/marcasController.php?c=1" method="POST"> 
                            <div class="input-group ">
                                <input type="text" class="form-control" id="nombre"  oninput="restrictInput(event)" maxlength="30" placeholder="Ingrese una nueva marca">
