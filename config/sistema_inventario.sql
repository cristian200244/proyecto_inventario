...
-- Volcando datos para la tabla sistema_inventario.facturas: ~1 rows (aproximadamente)
DELETE FROM `facturas`;
INSERT INTO `facturas` (`id_factura`, `id_persona`, `id_servicio`, `fecha`, `total`, `id_tipo_dispositivo`) VALUES
	(1, 1, 1, '2023-06-26', 4536435, 3);
...
-- Volcando datos para la tabla sistema_inventario.personas: ~1 rows (aproximadamente)
...
INSERT INTO `personas` (`id_persona`, `id_rol`, `id_tipo_documento`, `id_ciudad`, `numero_documento`, `primer_nombre`, `segundo_nombre`, `primer_apellido`, `segundo_apellido`, `direccion`, `telefono`, `id_sexo`, `correo`, `estado`) VALUES
	(1, 2, 1, 1, '1343646666', 'JAIME', '', 'ANDRADE', '', 'CALLE LOS OLIVOS 34-12', '3244555353', 1, 'JAIMW8@GMAIL.COM', 0);
...
INSERT INTO `servicios` (`id_servicio`, `id_persona`, `id_tipo_dispositivo`, `id_marca`, `id_tipo_servicio`, `codigo`, `id_estado_producto`, `fecha`, `falla`) VALUES
	(1, 1, 3, 2, 1, '5338744', 1, '2023-06-26', 'FALLA EN LOS CRD');
...
-- Volcando datos para la tabla sistema_inventario.tipo_servicios: ~1 rows (aproximadamente)
...
INSERT INTO `usuarios` (`id`, `id_persona`, `password`, `correo`, `estado`) VALUES
	(1, 10, '123456', 'OLVERYUCUNA@GMAIL.COM', 1);
